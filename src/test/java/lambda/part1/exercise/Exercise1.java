...
class Exercise1 {
    ...
    void sortPersonsByAgeUsingArraysSortLocalComparator() {
        ...
        Arrays.sort(persons, new ByAgeComparator());
    ...
    void findFirstWithAge30UsingGuavaPredicate() {
        ...
        class isAge30Predicate implements Predicate<Person> {
            @Override
        ...
        Person person = FluentIterable.from(persons).firstMatch(new isAge30Predicate()).get();
